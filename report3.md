...
The url is now "http://ieng6-201.ucsd.edu:4444/add-message?s=Hi". Similar to the second screenshot, the path is the same however the query is different. A new, different word is added to the StringBuilder as our query is different. The word "Hi" is added to our StringBuilder.
